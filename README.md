...
This is a command line tool that will convert Minecraft 1.14.3 anvil worlds to Nukkit's anvil world format.
...
## Requeriments
Before you convert you need to optimize your world using Minecraft 1.14.3.

This tool only supports Minecraft Java Edition 1.14.3, other versions and unoptimized worlds in different versions 
